     ...
     &                            'read time and record indices.'
        ...
        nrechis=0
        nrecavg=0
         write(stdout,'(6x,2A,G12.4,1x,A,I4)')
     &          'GET_INITIAL -- ',
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (u(0,0,1,1), ncid, varid,
     &                                        indx, u3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (v(0,0,1,1), ncid, varid,
     &                                        indx, v3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (t(0,0,1,1,itrc), ncid,  varid,
     &                                               indx, r3dvar)
          if (ierr .ne. nf_noerr) then
         write(stdout,2) vname(1,indxT+itrc-1)(1:lvar)
     &                                , indx, ininame(1:lstr)
            goto 99
          endif
        else
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (Akv(0,0,0), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
             write(stdout,2) vname(1,indxAkv)(1:lvar)
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (Akt(0,0,0,itemp), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
             write(stdout,2) vname(1,indxAkt)(1:lvar)
     &               , indx, ininame(1:lstr), nf_strerror(ierr)
            goto 99
          endif
        else
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (Akt(0,0,0,isalt), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
             write(stdout,2) vname(1,indxAks)(1:lvar)
     &               , indx, ininame(1:lstr), nf_strerror(ierr)
            goto 99
          endif
        else
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (hbbl(0,0), ncid, varid,
     &                                           indx, r2dvar)
        if (ierr .ne. nf_noerr) then
           write(stdout,2) vname(1,indxHbbl)(1:lvar)
     &         , indx, ininame(1:lstr), nf_strerror(ierr)
          goto 99
        endif
      else
